...
|                                                                           |                                                                                                                                                                                                                                                                                                                                                                                                |                                       |             |
| ------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-----------------------------------: | :---------: |
| Bezeichnung des Modells                                                   | Kurzinfo                                                                                                                                                                                                                                                                                                                                                                                       |              Modellgröße              | Open Source |
...
| [**LLaMA**](https://ai.meta.com/llama)                                    | Anbieter Meta trainiert die Modellvarianten _LLaMA Chat_ für Dialoge sowie _Code LLaMA_ mit code-spezifischen Datensätzen für die Softwareentwicklung.                                                                                                                                                                                                                                         |         65 (LLaMA)70 (LLaMA-2)        |      J      |
